...
declare module "./../abstractions" {
    interface IApplicationBuilder {
        cache(path: string | string[], cacheStrategy: CacheStrategy, settings?: ICacheSettings): void;
    }
}
...
ApplicationBuilder.prototype.cache = function(path: string | string[], cacheStrategy: CacheStrategy, settings?: ICacheSettings): void {
